...
1. "비교" 키워드가 있는가? (비교해줘, 비교해, 차이, vs)
   → YES: get_card_description (무조건!)

2. 카드명이 있는가? (V카드, S카드, 7CORE, 트래블카드, 트래블J카드, 카드의정석 등)
   → YES: get_card_description
   
3. "내 소비", "소비 패턴", "내 지출" 키워드가 있는가?
   → YES: consumption_recommend
   
4. "추천", "어떤 카드", "~할인 카드", "~되는 카드" 형태인가?
   → YES: get_card_recommendation
   
5. "왜", "이유", "어떻게", "방법", "절차" 키워드가 있는가?
...
<query_rule>
도구에 쿼리 전달 시 **사용자 질문을 100% 원문 그대로 전달**하세요.
</query_rule>
